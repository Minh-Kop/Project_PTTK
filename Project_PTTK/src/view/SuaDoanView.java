...
public class SuaDoanView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SuaDoanView frame = new SuaDoanView();
	...
	public SuaDoanView() {
		...
		JLabel lblThemDoan = new JLabel("Sửa thông tin đoàn");
		...
		txtTenDoan.setText("Đoàn cầu lông");
